...
def binned_statistic(x, values, statistic='mean',
                     bins=10, range=None, percentile=50):
    """
    ...
    medians, edges, binnumbers = binned_statistic_dd(
        [x], values, statistic, bins, range, percentile=percentile)
...
def binned_statistic_2d(x, y, values, statistic='mean',
                        bins=10, range=None, expand_binnumbers=False, percentile=50):
    """
    ...
    medians, edges, binnumbers = binned_statistic_dd(
        ...
        expand_binnumbers=expand_binnumbers, percentile=percentile)
