...
from .mpcommon import EPS, in_bounds, make_strictly_feasible
...
TERMINATION_MESSAGES = {
    ...
    5: "Steps reached accuracy limits"
}
...
def least_squares(
        ...
        jac_sparsity=None, max_nfev=None, verbose=0, dx_lim=None,
        args=(), kwargs={}):
    ...
    if method == 'lm':
        ...
        result = trf(fun_wrapped, jac_wrapped, x0, f0, J0, lb, ub, ftol, xtol,
                     ...
                     tr_options.copy(), verbose, dx_lim=dx_lim)
